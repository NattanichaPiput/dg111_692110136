...
**คำตอบ: เพราะ เป็น Pass by value จึงเปลี่ยนแค่ "value" แต่ "hp" ไม่เปลี่ยนแปลง**

### 2.2 `lerp` — Local Scope

**คำถาม:** ทำไม `main()` ถึงมองไม่เห็นตัวแปร `result` ทั้งที่มันถูกประกาศไว้ในไฟล์เดียวกัน?

**คำตอบ: เพราะ "result" เป็น Local variable ที่สามารถใช้ได้แค่ใน คำสั่ง "lerp()"**
...
**คำตอบ: เพราะ เป็น Pass by value เลยเปลี่ยนแค่ ตัว "min" แต่ "diceMin" ไม่เปลี่ยนแปลง**
...
**คำตอบ: เพราะ เป็น Pass by value เลยเปลี่ยนแค่ ตัว "current" แต่ "score" ไม่เปลี่ยนแปลง**
